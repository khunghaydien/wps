...
const ACTIONS = {
  ADD_TO_FOUND_EMPLOYEES: 'DA_APPR_ADD_TO_FOUND_EMPLOYEES',
  CLEAR_FOUND_EMPLOYEES: 'DA_APPR_CLEAR_FOUND_EMPLOYEES',
  CLEAR_SELECTION: 'DA_APPR_CLEAR_SELECTION',
  ADD_TO_SELECTED_EMPLOYEES: 'DA_APPR_ADD_TO_SELECTED_EMPLOYEES',
  REMOVE_FROM_SELECTED_EMPLOYEES: 'DA_APPR_REMOVE_FROM_SELECTED_EMPLOYEES',
  CLEAR_SELECTED_EMPLOYEES: 'DA_APPR_CLEAR_SELECTED_EMPLOYEES',
  INITIALIZE_EXCLUDED_EMPLOYEES: 'DA_APPR_INITIALIZE_EXCLUDED_EMPLOYEES',
  ADD_TO_EXCLUDED_EMPLOYEES: 'DA_APPR_ADD_TO_EXCLUDED_EMPLOYEES',
  REMOVE_FROM_EXCLUDED_EMPLOYEES: 'DA_APPR_REMOVE_FROM_EXCLUDED_EMPLOYEES',
  CLEAR_EXCLUDED_EMPLOYEES: 'DA_APPR_CLEAR_EXCLUDED_EMPLOYEES',
  UPDATE: 'DA_APPR_UPDATE',
};
...
type AddToFoundEmployees = {
  type: 'DA_APPR_ADD_TO_FOUND_EMPLOYEES';
  payload: EmployeeShowObj[];
};

type ClearFoundEmployees = {
  type: 'DA_APPR_CLEAR_FOUND_EMPLOYEES';
};

type ClearSelection = {
  type: 'DA_APPR_CLEAR_SELECTION';
};

/* selectedEmployees */
type AddToSelectedEmployees = {
  type: 'DA_APPR_ADD_TO_SELECTED_EMPLOYEES';
  payload: EmployeeShowObj[];
};

type RemoveFromSelectedEmployees = {
  type: 'DA_APPR_REMOVE_FROM_SELECTED_EMPLOYEES';
  payload: EmployeeShowObj[];
};

type ClearSelectedEmployees = {
  type: 'DA_APPR_CLEAR_SELECTED_EMPLOYEES';
};

type InitializeExcludedEmployees = {
  type: 'DA_APPR_INITIALIZE_EXCLUDED_EMPLOYEES';
  payload: string[];
};
type AddToExcludedEmployees = {
  type: 'DA_APPR_ADD_TO_EXCLUDED_EMPLOYEES';
  payload: string[];
};

type RemoveFromExcludedEmployees = {
  type: 'DA_APPR_REMOVE_FROM_EXCLUDED_EMPLOYEES';
  payload: string[];
};
type ClearExcludedEmployees = {
  type: 'DA_APPR_CLEAR_EXCLUDED_EMPLOYEES';
};
