...
export const ACTIONS = {
  ...
  SET_AVAILABILITY_DATE_SUCCESS:
    'MODULES/UI/RESOURCE_AVAILABILITY/SET_AVAILABILITY_DATE_SUCCESS',
};
...
const setResourceAvailabilityDate = (date: string) => ({
  type: ACTIONS.SET_AVAILABILITY_DATE_SUCCESS,
  payload: date,
});
//
// actions
...
export const actions = {
  ...
  setAvailabilityDate:
    (date: string) =>
    (dispatch: AppDispatch): void | any =>
      dispatch(setResourceAvailabilityDate(date)),
};
...
export default ((state = initialState, action) => {
  switch (action.type) {
    ...
    case ACTIONS.SET_AVAILABILITY_DATE_SUCCESS:
      return {
        ...state,
