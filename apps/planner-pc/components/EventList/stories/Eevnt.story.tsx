...
export default {
  title: 'planner-pc/EventList/Event',
  decorators: [
    (story: Function): ReactElement => <Decorator>{story()}</Decorator>,
  ],
};

export const Basic = (): React.ReactElement => (
  <Event isReadOnly={false}>CW1</Event>
);

Basic.storyName = 'basic';

export const IsReadOnly = (): ReactElement => (
  <Event isReadOnly>Read Only Mode</Event>
);
...
export const LongText = (): ReactElement => (
  <Event isReadOnly={false}>
    ...
    fringilla. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices
    posuere cubilia Curae; In ac dui quis mi consectetuer lacinia. Nam pretium
    ...
    Pellentesque ut neque. Pellentesque habitant morbi tristique senectus et
    netus et malesuada fames ac turpis egestas. In dui magna, posuere eget,
    ...
    auctor quis, euismod ut, mi. Aenean viverra rhoncus pede. Pellentesque
    habitant morbi tristique senectus et netus et malesuada fames ac turpis
    egestas. Ut non enim eleifend felis pretium feugiat. Vivamus quis mi.
