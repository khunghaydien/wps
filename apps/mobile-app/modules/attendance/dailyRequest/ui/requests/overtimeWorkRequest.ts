...
type Initialize = {
  type: 'MOBILE_APP/MODULES/ATTENDANCE/DAILY_REQUEST/UI/REQUESTS/OVERTIME_WORK_REQUEST/INITIALIZE';
  payload: {
...
type Update = {
  type: 'MOBILE_APP/MODULES/ATTENDANCE/DAILY_REQUEST/UI/REQUESTS/OVERTIME_WORK_REQUEST/UPDATE';
  payload: {
    key: Keys;
    value: Values;
  };
...
const INITIALIZE: Initialize['type'] =
  'MOBILE_APP/MODULES/ATTENDANCE/DAILY_REQUEST/UI/REQUESTS/OVERTIME_WORK_REQUEST/INITIALIZE';

const UPDATE: Update['type'] =
  'MOBILE_APP/MODULES/ATTENDANCE/DAILY_REQUEST/UI/REQUESTS/OVERTIME_WORK_REQUEST/UPDATE';
