...
import { OvertimeWorkRequest } from '../../../../../domain/models/attendance/AttDailyRequest/OvertimeWorkRequest';
...
import './OvertimeWorkRequestPage.scss';

const ROOT =
  'mobile-app-pages-attendance-daily-request-details-overtime-work-request-page';

export type Props = Readonly<{
  readOnly: boolean;
  request: OvertimeWorkRequest;
  validation: {
    [key: string]: string[];
  };
...
export default class OvertimeWorkRequestPage extends React.Component<Props> {
  render() {
    const {
      readOnly,
      request,
