  ...
  return Yup.object().shape({
    report: Yup.object().shape({
      ...
      costCenterName: Yup.string()
        ...
        .nullable(),
      isCustomRequestRequired: Yup.boolean(),
      customRequestId: Yup.string()
        .when('isCustomRequestRequired', {
          is: (isCustomRequestRequired) => !!isCustomRequestRequired,
          then: Yup.string().nullable().required(msg().Common_Err_Required),
        })
        .nullable(),
      ...
      vendorId: Yup.string()
        ...
        .nullable(),
      isFileAttachmentRequired: Yup.boolean(),
      ...
      paymentDueDate: Yup.string()
        ...
        .nullable(),
      attachedFileList: Yup.array()
        .when(`isFileAttachmentRequired`, {
          is: (isFileAttachmentRequired) => !!isFileAttachmentRequired,
          then: Yup.array().ensure().min(1, 'Common_Err_Required'),
        })
        .nullable(),
