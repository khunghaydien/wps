...
type Initialize = {
  type: 'TIMESHEET_PC/UI/DAILY_REQUEST/REQUESTS/EARLY_START_WORK_REQUEST/INITIALIZE';
  payload: {
...
type Update = {
  type: 'TIMESHEET_PC/UI/DAILY_REQUEST/REQUESTS/EARLY_START_WORK_REQUEST/UPDATE';
  payload: {
    key: Keys;
    value: Values;
  };
...
const INITIALIZE: Initialize['type'] =
  'TIMESHEET_PC/UI/DAILY_REQUEST/REQUESTS/EARLY_START_WORK_REQUEST/INITIALIZE';

const UPDATE: Update['type'] =
  'TIMESHEET_PC/UI/DAILY_REQUEST/REQUESTS/EARLY_START_WORK_REQUEST/UPDATE';
