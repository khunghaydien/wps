...
const S = {
  OuterInput: styled.div<{ disabled?: boolean; isExpanded?: boolean }>`
    display: flex;
    align-items: center;
    height: 32px;
    background: ${({ disabled }) => (disabled ? Color.background : Color.base)};
...
const QuickSearchField = (props: Props) => {
  ...
  return (
    <S.OuterInput isExpanded={isExpanded} disabled={disabled}>
