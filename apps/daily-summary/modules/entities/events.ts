...
export const initialState: State = { targetDate: undefined, records: [] };

// Actions

export const ACTION_TYPES = {
  SET_TARGET_DATE: `/DAILY-SUMMARY/ENTITIES/EVENTS/SET_TARGET_DATE`,
  FETCH_SUCCESS: `/DAILY-SUMMARY/ENTITIES/EVENTS/FETCH_SUCCESS`,
  RESET: `/DAILY-SUMMARY/ENTITIES/EVENTS/RESET`,
} as const;
