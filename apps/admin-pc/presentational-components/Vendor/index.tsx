...
import DetailContainer from '../../containers/VendorContainer/DetailContainer';
import ListContainer from '../../containers/VendorContainer/ListContainer';
...
const ROOT = 'admin-pc-vendor';

const Vendor = ({ title, isShowDetail, useFunction }: Props) => {
  return (
    <div className={ROOT}>
