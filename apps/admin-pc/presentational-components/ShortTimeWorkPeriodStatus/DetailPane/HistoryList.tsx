...
import { ShortTimeWorkPeriodStatus } from '../../../models/short-time-work/ShortTimeWorkPeriodStatus';

import DataGrid from '../../../components/DataGrid';

import './HistoryList.scss';

const ROOT = 'admin-pc-short-time-work-period-status-detail-pane-history-list';
...
export type Props = {
  historyList: ShortTimeWorkPeriodStatus[];
  onClickEditButton: (arg0: ShortTimeWorkPeriodStatus) => void;
};
      ...
      <div className={ROOT}>
        ...
        <DataGrid
          columns={[
            ...
            {
              key: 'shortTimeWorkSettingName',
              name: msg().Admin_Lbl_ShortTimeWorkSetting,
              resizable: true,
            },
            {
              key: 'comment',
