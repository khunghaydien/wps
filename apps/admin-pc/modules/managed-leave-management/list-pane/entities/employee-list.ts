...
type SearchEmployeeSuccess = {
  type: 'MODULES/MANAGED_LEAVE_MANAGEMENT/ENTITIES/EMPLOYEE_LIST/SEARCH_EMPLOYEE_SUCCESS';
  payload: State;
};

type Clear = {
  type: 'MODULES/MANAGED_LEAVE_MANAGEMENT/ENTITIES/EMPLOYEE_LIST/CLEAR';
};
