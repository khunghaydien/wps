...
type Initialize = {
  type: 'ADMIN-PC/MODULES/JOB_TYPE/UI/DETAIL/INITIALIZE';
};

type SetBaseRecord = {
  type: 'ADMIN-PC/MODULES/JOB_TYPE/UI/DETAIL/SET_BASE_RECORD';
  payload: JobType;
};

type SetBaseRecordByKeyValue = {
  type: 'ADMIN-PC/MODULES/JOB_TYPE/UI/DETAIL/SET_BASE_RECORD_BY_KEY_VALUE';
  payload: {
    key: string;
...
export const INITIALIZE: Initialize['type'] =
  'ADMIN-PC/MODULES/JOB_TYPE/UI/DETAIL/INITIALIZE';

export const SET_BASE_RECORD: SetBaseRecord['type'] =
  'ADMIN-PC/MODULES/JOB_TYPE/UI/DETAIL/SET_BASE_RECORD';

export const SET_BASE_RECORD_BY_KEY_VALUE: SetBaseRecordByKeyValue['type'] =
  'ADMIN-PC/MODULES/JOB_TYPE/UI/DETAIL/SET_BASE_RECORD_BY_KEY_VALUE';

export const actions = {
  initialize: (): Initialize => ({
    type: INITIALIZE,
  }),
  setBaseRecord: (baseRecord: JobType): SetBaseRecord => ({
