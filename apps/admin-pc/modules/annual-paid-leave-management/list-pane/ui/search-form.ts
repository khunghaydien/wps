...
const UPDATE_EMPLOYEE_CODE_QUERY =
  'MODULES/ANNUAL_PAID_LEAVE_MANAGEMENT/UI/SEARCH_FORM/UPDATE_EMPLOYEE_CODE_QUERY';
const UPDATE_EMPLOYEE_NAME_QUERY =
  'MODULES/ANNUAL_PAID_LEAVE_MANAGEMENT/UI/SEARCH_FORM/UPDATE_EMPLOYEE_NAME_QUERY';
const UPDATE_DEPARTMENT_NAME_QUERY =
  'MODULES/ANNUAL_PAID_LEAVE_MANAGEMENT/UI/SEARCH_FORM/UPDATE_DEPARTMENT_NAME_QUERY';
const UPDATE_WORKING_TYPE_NAME_QUERY =
  'MODULES/ANNUAL_PAID_LEAVE_MANAGEMENT/UI/SEARCH_FORM/UPDATE_WORKING_TYPE_NAME_QUERY';
const UPDATE_TARGET_DATE_QUERY =
  'MODULES/ANNUAL_PAID_LEAVE_MANAGEMENT/UI/SEARCH_FORM/UPDATE_UPDATE_TARGET_DATE_QUERY';
export const CLEAR =
  'MODULES/ANNUAL_PAID_LEAVE_MANAGEMENT/UI/SEARCH_FORM/CLEAR';
