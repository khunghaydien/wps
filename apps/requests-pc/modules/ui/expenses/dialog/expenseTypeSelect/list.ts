...
export const ACTIONS = {
  ...
  SET_FAVORITES:
    'MODULES/REQUESTS/DIALOG/EXPENSE_TYPE_SELECT/LIST/SET_FAVORITES',
  FAVORITE: 'MODULES/REQUESTS/DIALOG/EXPENSE_TYPE_SELECT/LIST/FAVORITE',
  UNFAVORITE: 'MODULES/REQUESTS/DIALOG/EXPENSE_TYPE_SELECT/LIST/UNFAVORITE',
