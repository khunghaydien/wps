...
describe('Dialog', () => {
  ...
  describe('openRecordItemsCreateDialog()', () => {
    it('Should succesfully open hotel fee create dialog', async () => {
      await store.dispatch(dialogActions.openRecordItemsCreateDialog());

      expect(store.getActions()).toMatchSnapshot();
    });
  });

  describe('openRecordItemsConfirmDialog()', () => {
    it('Should succesfully open hotel fee confirm dialog', async () => {
      await store.dispatch(dialogActions.openRecordItemsConfirmDialog());

      expect(store.getActions()).toMatchSnapshot();
    });
  });

  describe('openRecordItemsDeleteDialog()', () => {
    it('Should succesfully open hotel fee delete dialog', async () => {
      await store.dispatch(dialogActions.openRecordItemsDeleteDialog());
