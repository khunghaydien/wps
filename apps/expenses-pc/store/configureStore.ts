...
import { empHistoryMiddlewares } from '@apps/domain/modules/exp/empHistoryList';
import { reportTypeListMiddlewares } from '@apps/domain/modules/exp/expense-report-type/list';
...
export default function configureStore(
  ...
  middlewares = [
    ...middlewares,
    ...empHistoryMiddlewares,
    ...reportTypeListMiddlewares,
  ];
