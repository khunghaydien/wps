...
import NewRoleForm from '@psa/components/Dialog/NewRoleForm';
...
const NewRoleFormContainer = (ownProps: OwnProps) => {
  ...
  useEffect(() => {
    ...
    dispatch(listCategory({ companyId: companyId }));
  }, []);
  ...
  const handleSubmit = (values) => {
    ...
    dispatch(saveRole(role, selectedProject.projectId, jobGradeList, mode));
  };
