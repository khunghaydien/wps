...
export default class Detail extends React.Component<Props, State> {
  ...
  render() {
    const { expRequest, isApexView, isHighlightDiff, isShowSidePanel } =
      this.props;
        ...
        <div className={contentClass}>
          ...
          >
            ...
            <Summary
              ...
              expPreRequest={expRequest.expPreRequest}
              baseCurrencySymbol={this.props.baseCurrencySymbol}
              baseCurrencyDecimal={this.props.baseCurrencyDecimal}
              ...
              isHighlightDiffSetting={isHighlightDiff}
              useJctRegistrationNumber={this.props.jctInvoiceManagement}
              alwaysDisplaySettlementAmount={
                this.props.userSetting.alwaysDisplaySettlementAmount
              }
            />
            ...
            <RecordsArea
              ...
              isHighlightDiff={
                isHighlightDiff && !isEmpty(expRequest.expPreRequest)
              }
              useJctRegistrationNumber={this.props.jctInvoiceManagement}
              openVendorDetail={this.openVendorDetailDialog}
            />
