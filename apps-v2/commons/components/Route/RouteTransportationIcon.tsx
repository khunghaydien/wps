...
export default class RouteTransportationIcon extends React.Component<Props> {
  render() {
    switch (this.props.lineType) {
      case '0':
        return <img src={ImgIconTransportationTrain} alt="JR在来線" />;
      case '1':
        return <img src={ImgIconTransportationTrain} alt="私鉄在来線" />;
      case '2':
        return <img src={ImgIconTransportationTrain} alt="地下鉄" />;
      case '3':
        return <img src={ImgIconTransportationTrain} alt="路面電車" />;
      case '4':
        return <img src={ImgIconTransportationWalk} alt="徒歩" />;
      case '5':
        return <img src={ImgIconTransportationBus} alt="バス" />;
      case '6':
        return <img src={ImgIconTransportationAirplane} alt="飛行機" />;
      case '7':
        return <img src={ImgIconTransportationShip} alt="船" />;
      case '8':
        return <img src={ImgIconTransportationTrain} alt="有料特急列車" />;
      case '9':
        return <img src={ImgIconTransportationBulletTrain} alt="新幹線" />;
      case '10':
        return <img src={ImgIconTransportationTrain} alt="寝台列車" />;
      case '11':
        return <img src={ImgIconTransportationTrain} alt="料急行列車" />;
      case '12':
        return <img src={ImgIconTransportationBus} alt="高速バス" />;
      case '13':
        return <img src={ImgIconTransportationCar} alt="自動車" />;
      case '14':
        return <img src={ImgIconTransportationBus} alt="空港連絡バス" />;
      default:
        return null;
    }
  }
