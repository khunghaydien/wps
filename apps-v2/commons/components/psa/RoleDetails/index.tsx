...
const RoleDetails = (props: Props) => {
  ...
  const isBtnDisabled = {
    ...
    submit: !isPlanning,
    recall: !isRequested || !props.accessSetting.canWithdrawProjectRoles,
    cancel:
      !(isConfirmed || isInProgress) ||
      !props.accessSetting.canCancelProjectRoles,
    delete: !(isPlanning || isNotFound) || isScheduling,
    rescheduleEndDate: !isInProgress || isScheduling,
    assignResource: !isPlanning || !props.accessSetting.canAssignProjectRoles,
    softBooking:
      isRequested ||
      isConfirmed ||
      isInProgress ||
    ...
    reschedule:
      !(isConfirmed || isInProgress) ||
      !props.accessSetting.canRescheduleProjectRoles,
    ...
    <div className={`${ROOT}`} ref={topRef}>
      ...
      <div className={`${ROOT}__content`}>
        ...
        {showScheduleDetail && (
          <BookingInformation
            canConfirmResource={
              isProjectTab && props.accessSetting.canConfirmProjectRoles
            }
            currentRoute={props.currentRoute}
