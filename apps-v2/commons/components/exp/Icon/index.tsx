...
import HideIcon from '@commons/images/icons/hide.svg';
import PreviewIcon from '@commons/images/icons/preview.svg';
...
export default class Icon extends React.PureComponent<Props> {
  render() {
    ...
    switch (this.props.type) {
      ...
      case 'preview':
        return <PreviewIcon {...additionalProps} />;
      case 'hide':
        return <HideIcon {...additionalProps} />;
