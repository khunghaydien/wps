...
const LOCATION_MAP = {
  ...
  'expenses-pc-print': {
    local: 'expenses-pc-print/index.html',
  ...
  'timesheet-pc-allowance': {
    local: 'timesheet-pc-allowance/index.html',
    vfp: 'TimesheetAllowance',
  },
  'timesheet-pc-objectively-event-log': {
    local: 'timesheet-pc-objectively-event-log/index.html',
    vfp: 'TimesheetObjectivelyEventLog',
  },
  'timesheet-pc-restreason': {
    local: 'timesheet-pc-restreason/index.html',
    vfp: 'TimesheetRestReason',
  },
  'test-api': {
  ...
  'capacity-editor-bulk': {
    local: 'capacity-editor-bulk/index.html',
    vfp: 'CapacityEditorBulk',
  },
  'capacity-editor-single': {
    local: 'capacity-editor-single/index.html',
    vfp: 'CapacityEditorSingle',
  },
  'psa-pc-talent-profile': {
    local: 'psa-pc-talent-profile/index.html',
    vfp: 'PSATalentProfile',
  },
  'timestamp-mobile': {
  ...
  static isLocal(): boolean {
    return (
      ...
      (window.location.href.split('.')[1] != null &&
        window.location.href.split('.')[1].includes('html?'))
    );
  }
