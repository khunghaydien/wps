...
test.skip('provides only date field only if allDay checked', () => {
  /*
...
test('submits a new event', async () => {
  ...
  // Act
  await act(async () => userEvent.click(page.submit));
...
test('deletes an event', async () => {
  ...
  // Act
  await act(async () => userEvent.click(page.delete));
  await act(async () => userEvent.click(page.confirmDialog.ok));

  // Assert
  // Wait for dispatching all async actions
  expect(ApiMock.invoke).toHaveBeenCalledWith(api);
});
...
test('closes popup window', async () => {
  ...
  // Act
  await act(async () => userEvent.click(page.outOfContent));
