...
import { isDailyRecordReadOnly } from '../../modules/selectors';
...
const mapStateToProps = (state: State) => ({
  ...
  isReadOnly:
    state.ui.editingDailyRemarks?.recordId &&
    isDailyRecordReadOnly(state.ui.editingDailyRemarks.recordId)(state),
});
