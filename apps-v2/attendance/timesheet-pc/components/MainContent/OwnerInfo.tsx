...
import { OwnerInfo as OwnerInfoModel } from '@attendance/domain/models/Timesheet';
...
const OwnerInfo: React.FC<Props> = ({ ownerInfo }) => {
  const departmentNameAndSeparator = ownerInfo?.department?.name
    ? [
