if(typeof(teasp) == 'object' && !teasp.resolved['5451'] && teasp.dialog && teasp.dialog.EmpApply){
...
teasp.dialog.EmpApply.prototype.ready = function(){
	this.applyTypes['patternS'].getMenuFlag = function(){
		if(this.pouch.isUseChangePattern()){
			if(this.patternSList.length <= 0 && this.patternLList.length <= 0){
				return 0;
			}
