define([
	...
	// 日次確定
	return declare("tsext.testAssist.EntryApplyDailyFix", EntryBase2, {
		/**
		 * @constructor
		...
		getApplyEmpDayRequest: function(){
			var month = Current.getMonth();
			var apply = Current.getCanceldApply(Constant.APPLY_TYPE_DAILY_FIX, this.getStartDate());
			var sd = this.getStartDate();
			var ed = this.getEndDate();
			return {
				...
				apply: {
					...
					applyType	: Constant.APPLY_TYPE_DAILY_FIX,
					startDate	: sd,
					endDate		: (ed || sd),
					note		: this.getNote()
				}
