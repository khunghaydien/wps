define([
	...
	// 早朝勤務申請
	return declare("tsext.testAssist.EntryApplyEarlyStart", EntryBase2, {
		/**
		 * @constructor
		...
		getApplyEmpDayRequest: function(){
			var month = Current.getMonth();
			var apply = Current.getCanceldApply(Constant.APPLY_TYPE_EARLY_WORK, this.getStartDate());
			var sd = this.getStartDate();
			var ed = this.getEndDate();
			return {
				...
				apply: {
					...
					applyType	: Constant.APPLY_TYPE_EARLY_WORK,
					startDate	: sd,
					endDate		: sd,
