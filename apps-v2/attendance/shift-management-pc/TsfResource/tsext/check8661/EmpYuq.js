define([
	...
	return declare("tsext.check8661.EmpYuq", null, {
		...
		getBaseTimeH    : function(){ return (this.obj.BaseTime__c / 60); },
		getSubject      : function(){ return this.obj.Subject__c || ''; },
		isAutoFlag      : function(){ return this.obj.AutoFlag__c || false; },
		isAdjustHourlyHoliday: function(){ return (this.obj.YearOfPaidRestTime__c ? true : false); }, // 時間単位有休調整レコード
		...
		getEmpApplyName : function(){
			if(this.isProvide() && !this.obj.EmpApplyId__c){
				return (this.obj.AutoFlag__c ? '定期付与' : '臨時付与');
