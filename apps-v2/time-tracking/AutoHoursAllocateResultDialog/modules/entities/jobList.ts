...
const ActionType = {
  ADD: '/TIME-TRACKING/AUTO-HOURS-ALLOCATE-RESULT-DIALOG/ENTITIES/JOB_LIST/ADD_JOB_LIST',
  FETCH_SUCCESS:
    '/TIME-TRACKING/AUTO-HOURS-ALLOCATE-RESULT-DIALOG/ENTITIES/JOB_LIST/FETCH_SUCCESS_ACTIVE_JOB_LIST',
} as const;
...
export const actions = {
  addJobList: (job): AddJobListAction => ({
    type: ActionType.ADD,
    payload: job,
  }),
 ...
 */
export const convertActiveJobList = (
 ...
 */
const addRemoteListJobToJobPickList = (
  jobList: JobPickListItem[],
  allocateJobList: JobPickListItem[]
): JobPickListItem[] => {
