...
import { getRequestDetail } from '@custom-request-pc/models';

import { AppDispatch } from '../AppThunk';
import { RequestDetail, Status } from '@custom-request-pc/types';

const STATUS_FIELD_NAME = NAMESPACE_PREFIX + 'Status__c';
const RECORD_ACCESS_FIELD_NAME = NAMESPACE_PREFIX + 'RecordAccessId__c';

export const ACTIONS = {
  GET_SUCCESS: 'MODULES/ENTITIES/REQUEST_DETAIL/GET_SUCCESS',
  UPDATE_STATUS_SUCCESS:
    'MODULES/ENTITIES/REQUEST_DETAIL/UPDATE_STATUS_SUCCESS',
  CLEAR_SUCCESS: 'MODULES/ENTITIES/REQUEST_DETAIL/CLEAR_SUCCESS',
};
  ...
  get:
    ...
    (dispatch: AppDispatch) => {
      ...
      return getRequestDetail(
        requestId,
        fieldsToSelect
          .filter((field) => field !== RECORD_ACCESS_FIELD_NAME)
