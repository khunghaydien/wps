...
import listDummyResponse from '@attendance/repositories/__tests__/mocks/att-managed-leave-grant-list';
  ...
  describe('action', () => {
    describe('show', () => {
      test('should return action', () => {
        expect(show('xxxxxxx', '2017-01-01', '2019-01-01', '8.5', '3')).toEqual(
          {
            type: SHOW,
            payload: {
              ...
              targetGrantHistoryRecordHoursGranted: '3',
            },
          }
        );
      });
