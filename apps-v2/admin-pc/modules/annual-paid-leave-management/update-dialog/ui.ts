...
type State = {
  ...
  readonly targetGrantHistoryRecordDaysGranted: number | null | undefined;
  readonly targetGrantHistoryRecordHoursGranted: number | null | undefined;
...
export const show = (
  ...
  targetGrantHistoryRecordHoursGranted: string
) => ({
  type: SHOW,
  payload: {
...
export const initialState: State = {
  ...
  targetGrantHistoryRecordHoursGranted: null,
  newDaysGranted: null,
};
  ...
  switch (action.type) {
    case SHOW:
      return {
        ...
        targetGrantHistoryRecordHoursGranted: action.payload
          .targetGrantHistoryRecordHoursGranted as number,
        newDaysGranted: String(
