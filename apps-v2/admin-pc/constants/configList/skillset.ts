...
const allowSelfEditingOptions = [
  {
    msgkey: 'Admin_Lbl_PsaAllowSelfEditingAllowed',
    value: SELF_EDITING_TYPE.Allowed,
  },
  {
    msgkey: 'Admin_Lbl_PsaAllowSelfEditingNotAllowed',
    value: SELF_EDITING_TYPE.NotAllowed,
  },
  /*   
  // DO NOT DELETE.TO BE SUPPORTED LATER. DON’T SHOW ON FE YET
  {
    msgkey: 'Admin_Lbl_PsaAllowSelfEditingApprovalRequired',
    value: SELF_EDITING_TYPE.ApprovalRequired,
  }, 
  */
];
...
const base: ConfigList = [
  ...
  },
  {
    ...
    isRequired: true,
    display: DISPLAY_DETAIL,
    options: allowSelfEditingOptions,
  },
  {
    key: 'ratingType',
    msgkey: 'Admin_Lbl_RatingType',
