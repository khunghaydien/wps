...
const base: ConfigList = [
  ...
  },
  {
    ...
    configList: [
      ...
      {
        key: 'canAssignProjectRoles',
        msgkey: 'Admin_Lbl_PsaCanAssignResource',
        type: FIELD_CHECKBOX,
        display: DISPLAY_DETAIL,
        labelSize: SIZE_MEDIUM,
      },
      {
        key: 'canWithdrawProjectRoles',
        msgkey: 'Admin_Lbl_PsaCanWithdraw',
        type: FIELD_CHECKBOX,
        display: DISPLAY_DETAIL,
        labelSize: SIZE_MEDIUM,
      },
      {
        key: 'canCancelProjectRoles',
        msgkey: 'Admin_Lbl_PsaCanCancel',
        type: FIELD_CHECKBOX,
        display: DISPLAY_DETAIL,
        labelSize: SIZE_MEDIUM,
      },
      {
        key: 'canRescheduleProjectRoles',
        msgkey: 'Admin_Lbl_PsaCanReschedule',
        type: FIELD_CHECKBOX,
        display: DISPLAY_DETAIL,
        labelSize: SIZE_MEDIUM,
      },
