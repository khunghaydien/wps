...
const base: ConfigList = [
  ...
  },
  {
    ...
    condition: (baseValueGetter) =>
      !baseValueGetter('changeApplyDateToHoliday'),
  },
  {
    key: 'changeApplyDateToHoliday',
    msgkey: 'Att_Lbl_ChangeApplyDateToHoliday',
    type: FIELD_CHECKBOX,
    display: DISPLAY_DETAIL,
  },
  {
    key: 'allowWorkDuringLeaveOfAbsence',
    msgkey: 'Admin_Lbl_AllowWorkDuringLeaveOfAbsence',
    type: FIELD_CHECKBOX,
    display: DISPLAY_DETAIL,
  },
];
