...
const mileageUnitOptions = [
  {
    msgkey: 'Exp_Sel_MileageUnitKilometer',
    value: 'kilometer',
  },
  {
    msgkey: 'Exp_Sel_MileageUnitMile',
    value: 'mile',
  },
];
...
const base: ConfigList = [
  { key: 'id', type: FIELD_HIDDEN },
  {
    ...
    configList: [
      ...
      {
        key: 'highlightExpReqRepDiff',
        msgkey: 'Admin_Lbl_ExpAllowDiffView',
        type: FIELD_CHECKBOX,
        label: 'Admin_Lbl_Use',
        help: 'Admin_Msg_ExpAllowDiffView',
      },
      {
        key: 'alwaysDisplaySettlementAmount',
        msgkey: 'Admin_Lbl_AlwaysDisplaySettlementAmount',
        type: FIELD_CHECKBOX,
        label: 'Admin_Lbl_Use',
        help: 'Admin_Msg_UseAlwaysDisplaySettlementAmount',
      },
      {
        key: 'displayCalendarOnExpenseModule',
        msgkey: 'Admin_Lbl_ExpDisplayCalendar',
        type: FIELD_CHECKBOX,
        label: 'Admin_Lbl_Use',
        help: 'Admin_Msg_ExpDisplayCalendar',
      },
      {
        key: 'useExpBetaFeatures',
        msgkey: 'Admin_Lbl_ExpEnableBetaFeatures',
        type: FIELD_CHECKBOX,
        label: 'Admin_Lbl_Use',
        help: 'Admin_Msg_ExpEnableBetaFeatures',
      },
    ],
  },
  {
  ...
  {
    section: 'MileageUnitSetting',
    msgkey: 'Admin_Lbl_MileageUnitSetting',
    isExpandable: true,
    configList: [
      {
        key: 'expMileageUnit',
        msgkey: '$Exp_Clbl_MileageUnit',
        type: FIELD_SELECT,
        options: mileageUnitOptions,
        props: 'expMileageUnit',
        size: SIZE_SMALL,
        multiLanguageValue: true,
        isRequired: true,
      },
