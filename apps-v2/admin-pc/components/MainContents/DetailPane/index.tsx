...
type HeaderProps = {
  ...
  canDeleteHistoryEvenIfItHasNoSiblings?: boolean;
};
...
export const DetailPaneHeaderSubHistory = createDetailPaneHeaderSub(
  ({
    canDeleteHistoryEvenIfItHasNoSiblings = false,
    ...props
  }: HeaderProps) => {
    let disableDeleteButton = false;
    let disabledRevisionBtn = false;
    if (props.searchHistory.length > 0) {
      const selectedHistoryIsNewest =
        props.currentHistory === props.searchHistory[0].id;
      const selectedHistoryHasPrevSibling = props.searchHistory.length > 1;

      const deletable =
        selectedHistoryIsNewest &&
        (selectedHistoryHasPrevSibling ||
      ...
      if (props.currentRoleId) {
        ...
        const deletable =
          selectedHistoryIsNewest &&
          (selectedHistoryHasPrevSibling || props.currentRoleId !== 'primary');
        disableDeleteButton = !deletable;
        disabledRevisionBtn = !selectedHistoryIsNewest;
      }
    } else {
      ...
      <div className={ROOT}>
        {this.props.configList.history ? (
          ...
          <DetailPaneButtonsHeader
            ...
            onClickUpdateHistoryButton={this.props.onClickUpdateHistoryButton}
            hideHeaderButton={this.props.hideHeaderButton}
          />
        )}
        <div className={`${ROOT}__scrollable`}>
          ...
          <DetailPaneBody
            ...
            useFunction={this.props.useFunction}
            component={this.props.modeBase !== 'new' && this.props.component}
            searchPsaSetting={this.props.searchPsaSetting}
          />
