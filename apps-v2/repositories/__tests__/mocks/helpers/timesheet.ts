...
import { Period } from '@apps/domain/models/attendance/Timesheet';
...
export const requestTypes: { [key in Code]?: AttDailyRequestType } = {
...
export const generateAttSummaryObject = (): AttSummary => ({
  ...
  performableActionForFix: detectPerformableActionForFix(STATUS.NotRequested),
});
...
export const generateAttRecordObjectList = (): AttDailyRecordFromRemote[] => {
  const attRecords = [];
