...
const ExchangeRate = (props: Props) => {
  const { isParentItem, readOnly, exchangeRateManual, exchangeRate } = props;
  ...
  const disabledInput = readOnly || !props.exchangeRateManual || !isParentItem;
  ...
  const rateArea = (
    <TextField
      ...
      {...props.getCustomHintProps('recordExchangeRate')}
    />
  );
