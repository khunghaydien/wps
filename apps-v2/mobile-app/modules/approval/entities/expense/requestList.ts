...
export const ACTIONS = {
  FETCH_SUCCESS: 'MODULES/APPROVAL/ENTITIES/EXPENSE/REQUEST_LIST/FETCH_SUCCESS',
  CLEAR_SUCCESS: 'MODULES/APPROVAL/ENTITIES/EXPENSE/REQUEST_LIST/CLEAR_SUCCESS',
  UPDATE_SUCCESS:
    'MODULES/APPROVAL/ENTITIES/EXPENSE/REQUEST_LIST/UPDATE_SUCCESS',
};
...
export const actions = {
  fetch:
    ...
    (dispatch): Promise<ExpRequestList> => {
      return fetchExpRequestReportList(idList, empId).then(
        (res: ExpRequestList) => {
