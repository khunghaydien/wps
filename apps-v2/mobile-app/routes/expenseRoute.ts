...
// mileage pages
const MileageMapContainer = (): Component =>
  import('../containers/pages/expense/MileageMapContainer');
...
const FilterDetailTransactionContainer = (): Component =>
  import('../containers/pages/expense/FilterDetailTransactionContainer');
...
const routes: RouteConfig = [
  {
    ...
    children: [
       ...
       */
      {
        path: `vendor/search/reportId=:reportId/backType=:backType`,
      ...
      {
        path: 'transaction/advance-search/detail',
        component: FilterDetailTransactionContainer,
        dynamicImport: true,
        mapParamsToProps: () => ({}),
      },
      {
      ...
      /**
       * Mileage Map Container
       */
      {
        path: 'record/mileage/map',
        component: MileageMapContainer,
        dynamicImport: true,
      },
      {
       ...
       */
      {
        path: 'credit-card/transactions/:reportId?/:recordId?',
