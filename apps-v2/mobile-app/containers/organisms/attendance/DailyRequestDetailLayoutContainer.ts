...
const mapStateToProps = (
  ...
  return {
    isLocked: timesheet.isLocked || record?.isLocked,
...
const mergeProps = (
  ...
  workingType: stateProps.workingType,
  ...
  onClickStartEditing: () => {
    ...
    dispatchProps.startEditingHandler(
      stateProps.target,
      stateProps.record,
      stateProps.workingType,
  ...
  lifecycle({
    componentDidMount: (
      ...
      appService.withLoading(() =>
        RequestHistoryRepository.fetchList(id).then((result) =>
