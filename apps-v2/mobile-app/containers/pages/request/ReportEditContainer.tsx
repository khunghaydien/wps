  ...
  return (
    <ReportEditPage
      ...
      showSwitchReportTypeConfirmDialog={
        ownProps.showSwitchReportTypeConfirmDialog
      }
...
const mergeProps = (
  ...
  onClickSearchVendor: () => {
    ...
    pushHistoryWithPrePage(
      ownProps.history,
      `/request/vendor/search/reportId=${reportId}/backType=null`
    );
  },
  ...
  showSwitchReportTypeConfirmDialog: (
    ...
    if (isShowRemovePaymentMethodMsg) {
      return (
        dispatchProps
          .showConfirm(msg().Exp_Msg_ConfirmRemovePaymentMethod)
          // @ts-ignore
  ...
  withFormik({
    ...
    handleSubmit: (values, { props }) => {
      const reportValues = {
        ...
        cashAdvanceDate: null,
      };

      props
        .saveRequest(reportValues)
        // @ts-ignore
        .then(([{ reportId }, ..._rest]) => {
