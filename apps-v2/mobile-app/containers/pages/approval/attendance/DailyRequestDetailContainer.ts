...
import { getDailyRequest } from '../../../../action-dispatchers/approval/AttendanceRequest';
import { reject } from '../../../../action-dispatchers/approval/Reject';
import { AppDispatch } from '../../../../action-dispatchers/AppThunk';

import AttDetailPage from '../../../../components/pages/approval/attendance/DailyRequest';

const mapStateToProps = (state, ownProps) => ({
  ...ownProps,
  request: state.approval.entities.attendance.dailyRequest,
  detailList: detailSelectors.detailListSelector(
    state.approval.entities.attendance.dailyRequest
  ),
...
export default compose(
  ...
  lifecycle({
    componentDidMount: (dispatch: AppDispatch, props) => {
      ...
      dispatch(getDailyRequest(props.requestId));
    },
  })
