...
export const vendorBackTypes = Object.freeze({
  REPORT: 'REPORT',
  RECORD_VENDOR: 'RECORD_VENDOR',
  RECORD_MERCHANT: 'RECORD_MERCHANT',
});

export type VendorBackType = $Values<typeof vendorBackTypes>;
...
export const getRecentlyUsedVendor = (
  ...
  Api.invoke({
    ...
    param: { employeeBaseId, companyId, isPersonalVendor },
...
export const saveVendor = (
  ...
  return Api.invoke({
    ...
    param: { ...vendor, employeeId, empHistoryId: subroleId },
...
export const updateVendor = (
  ...
  return Api.invoke({
    ...
    param: { ...vendor, empId, empHistoryId: subroleId },
  }).then((response: PersonalVendorSaveRes) => response);
};

export const deleteVendor = (id: string, subroleId?: string) => {
  return Api.invoke({
    path: '/exp/vendor/delete',
    param: { id, empHistoryId: subroleId },
  }).then((response: string) => response);
};

export const undoVendorDelete = (
  id: string,
  empHistoryId?: string
): Promise<void> =>
  Api.invoke({
    path: '/exp/vendor/restore',
    param: { id, empHistoryId },
  });
